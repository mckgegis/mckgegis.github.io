...
const s1 = (sketch) => {
  ...
  sketch.draw = () => {
   ...
   sketch.preload = () => {
    song1 = sketch.loadSound(`assets/sounds/fantasy.mp3`);
  ...
  function togglePlaying() {
    if (!song1.isPlaying()) {
      song1.play();
      sketch.playButton.html("paws");
      dakine2 = true;
    } else {
      song1.pause();
      sketch.playButton.html("pway");
      dakine2 = false
    };
  };

  const createButtons = () => {
    sketch.playButton = sketch.createButton("pway");
    sketch.playButton.mousePressed(togglePlaying);
    // playButton.addClass('control button1');
  };
...
const s2 = (sketch) => {
  ...
  sketch.preload = () => {
    ...
    song2 = sketch.loadSound(`assets/sounds/sound_4.mp3`);
...
const sketch1 = new p5(s1, document.getElementById('cont1'));
const sketch2 = new p5(s2, document.getElementById('cont2'));
const sketch3 = new p5(s3, document.getElementById('cont3'));